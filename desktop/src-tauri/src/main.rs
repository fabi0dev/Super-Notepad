...
fn main() {
    tauri::Builder::default()
        ...
        .on_menu_event(|app, event| match event.id.as_ref() {
            "settings" => menu::emit_menu_action(app, "settings"),
            "menu-new-note" => menu::emit_menu_action(app, "new-note"),
            "menu-new-folder" => menu::emit_menu_action(app, "new-folder"),
            "menu-toggle-list" => menu::emit_menu_action(app, "toggle-list"),
            "menu-focus-search" => menu::emit_menu_action(app, "focus-search"),
            "menu-open-file" => menu::menu_open_file(app),
            _ => {}
        })
        .setup(|app| {
